...
namespace LibraryManagementSystem.Migrations
{
    ...
    [Migration("20230504035817_book-request-added")]
    partial class bookrequestadded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryManagementSystem.Areas.Identity.Data.LMSUser", b =>
                {
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.BookDetails", b =>
                {
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.ReservationDetails", b =>
                {
                    b.Property<int>("ReservationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.FineDetails", b =>
                {
                    b.HasOne("LibraryManagementSystem.Models.ReservationDetails", "Reservation")
                        .WithMany()
                        .HasForeignKey("ReservationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryManagementSystem.Areas.Identity.Data.LMSUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("LibraryManagementSystem.Models.ReservationDetails", b =>
                {
                    b.HasOne("LibraryManagementSystem.Models.BookDetails", "Book")
                        .WithMany()
                        .HasForeignKey("BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryManagementSystem.Areas.Identity.Data.LMSUser", "ReservedUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("LibraryManagementSystem.Areas.Identity.Data.LMSUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
